...
(function ($) {
  ...
  var ProductManager = (function(){
    ...
    */
    ...
    var addProduct = function(id, name, summary, price, quantity, image, delivery) {
      var products = getAllProducts();
      products.push({
        id: id,
        name: name,
    ...
    */
    ...
    var setProduct = function(id, name, summary, price, quantity, image, delivery) {
      ...
      if(!$.isNumeric(delivery)){
        console.error("delivery is not a number")
        return false;
      }
      ...
      if(!updatePoduct(id)){
        addProduct(id, name, summary, price, quantity, image, delivery);
      }
    }
  ...
  var loadMyCartEvent = function(targetSelector){
    ...
    if(options.cartItems && options.cartItems.constructor === Array) {
      ...
      $.each(options.cartItems, function() {
        ProductManager.setProduct(this.id, this.name, this.summary, this.price, this.quantity, this.image, this.delivery);
      });
    }
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<table class="table table-hover" style="overflow-x:auto;" id="' + idCartTable + '"></table>' +
        '</div>' +
        '<div class="modal-footer">' +
        '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>' +
        '<button type="button" class="check btn btn-primary ' + classCheckoutCart + '">Checkout</button>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    ...
    var drawTable = function(){
      ...
      if(products.length && discountPrice !== null) {
        $cartTable.append(
          '<tr style="color: red">' +
          '<td></td>' +
          '<td><strong>Total (with delivery charge)</strong></td>' +
          '<td></td>' +
          '<td></td>' +
    ...
    */
    ...
    $(document).on('click', targetSelector, function(){
      ...
      var delivery = $target.data('delivery');

      ProductManager.setProduct(id, name, summary, price, quantity, image, delivery);
      $cartBadge.text(ProductManager.getTotalQuantity());
